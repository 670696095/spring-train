     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
         ...
         <tr>
             ...
             <td width="35%">
                 <input type="text" id="paramsUser.userCompany" class="form-control" name="paramsUser.userCompany" value="${""}"/>
             </td>
             <td width="15%" align="right" style="padding-right:5px">用户地址：</td>
             <td width="35%">
                 <input type="text" id="paramsUser.userAddress"class="form-control" name="paramsUser.userAddress" value="${""}"/>
             </td>
         </tr>
         </c:if>
         <tr>
             ...
             <td width="35%">
                 <input type="text" id="paramsUser.userMail"class="form-control" name="paramsUser.userMail" value="${""}"/>
             </td>
